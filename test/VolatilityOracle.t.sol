...
contract VolatilityOracleTest is Test {
    ...
    function testCacheMetadataFor() public {
        ...
        (uint32 maxSecondsAgo, uint24 gamma0, uint24 gamma1, int24 tickSpacing) =
    ...
    function testEstimate24H1() public {
        ...
        (uint256 feeGrowthGlobal0, uint256 feeGrowthGlobal1, uint256 timestamp) =
    ...
    function testEstimate24H3() public {
        ...
        for (uint8 i; i < 28; i++) {
            ...
            if (i == 0) {
                assertEq(readIndex, 0);
            } else if (i < 25) {
                assertEq(readIndex, 1);
            } else {
                assertEq(readIndex, (i + 2) % 25);
            }
